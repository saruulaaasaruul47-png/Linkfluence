...
import { contractActionSchema, contractDocumentSchema, contractIdSchema, contractListSchema } from './contract.schema.js';
export const contractRouter = Router();
contractRouter.use(authenticate);
contractRouter.get('/', validate(contractListSchema), contractController.list);
