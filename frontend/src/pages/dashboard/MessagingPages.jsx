...
export function MessagesPage() {
  ...
  return <DashboardPage className="relative !max-w-none !p-0">
    ...
    <div className="messaging-shell grid h-[calc(100dvh-76px)] min-h-0 overflow-hidden border-y border-white/10 bg-[#0d1115] lg:grid-cols-[21rem_minmax(0,1fr)] xl:grid-cols-[22rem_minmax(0,1fr)]">
