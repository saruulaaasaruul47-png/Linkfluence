import { Bookmark, CheckCircle2, Star, UserCheck, UserPlus } from 'lucide-react'
import { useNavigate } from 'react-router-dom'
import { useMarketplace } from '../../../context/marketplace-context'
import { useAuth } from '../../../context/auth-context'
import { MarketplaceImage } from '../MarketplaceImage'

export function BusinessCard({ business, compact = false }) {
  ...
  return <article className={`group relative isolate overflow-hidden border border-white/15 bg-[#171717] transition duration-500 hover:-translate-y-1 hover:border-white/30 ${compact ? 'min-h-[22rem] rounded-[1.3rem]' : 'min-h-[29rem] rounded-[1.6rem]'}`}>
